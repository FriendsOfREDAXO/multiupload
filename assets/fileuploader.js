...
jQuery(document).ready(function()
{
   ...
   */
    jQuery('.edit_uploads').on('click','li', function(event)
  {
  ...
  */
  jQuery('.edit_uploads .rex-form-submit').on('click', 'input', function()
  {
   ...
   */
  jQuery('.edit_uploads').on('click','.clear_link', function(event)
  {
   ...
   */
  jQuery('.edit_uploads').on('click', '.apply_link', function(event)
  {
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button btn btn-save rex-form-aligned">Klicke um Dateien hochzuladen / oder per Drag & Drop ablegen</div>' +
